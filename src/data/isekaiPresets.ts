import { WorldArchetype, ReincarnationMethod, CheatSkill, Language } from '../types';
...
export const WORLD_PRESETS: WorldPreset[] = [
  ...
  },
  {
    ...
    description: {
      et: 'Tulevikumaailm, kus neoonlinnade varjus kohtub digitaalne qi-energia ja küberneetilised surematud.',
  ...
  },
  {
    ...
    description: {
      et: 'Tume fantaasiamaailm, kus sa sündisid Deemonite armee kindraliks või troonipärijaks inimeste vastu.',
...
export const REINCARNATION_PRESETS: ReincarnationPreset[] = [
  ...
  },
  {
    ...
    description: {
      et: 'Jumal lennutas kogemata välgu ja annab vabanduseks hiiglasliku lisajõu.',
...
import { getSkillImageUrl } from '../utils/imageGenerator';
